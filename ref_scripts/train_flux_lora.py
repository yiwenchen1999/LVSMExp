...
def main(args):
    ...
    #* b. Flux Transformer(equivalent to UNET)
    ...
    #& ---------------------3. CREATING BLOCK FOR IMAGE CONDITIONING ----------------------------
    # enable image inputs
    with torch.no_grad():
        #* 3.1. Create a new linear layer for image conditioning (this is equal to doubling the conv_in layers of UNET)
    ...
    #* 4.1. Define target modules for LoRA
    ...
    #* 4.2. Create LoRA configuration and add adapter
    ...
    #* 4.3. Enable training for norm layers if specified
    if args.train_norm_layers:
        for name, param in flux_transformer.named_parameters():
            if any(k in name for k in NORM_LAYER_PREFIXES):
                param.requires_grad = True

    #& ---------------------5. MODEL SAVING & LOADING UTILS----------------------------
    ...
    #& ---------------------8. LR & OTHER TRAINING steps SCHEDULER SETUP----------------------------
    ...
    #* 9.2. get the text encoding ready(?)
    ...
    #* 9.3. Potentially load in the weights and states from a previous save
    ...
    #* 9.4. Logging some dataset samples
    ...
    #* 9.5. get the sigma schedule ready
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(flux_transformer):
                #* 10.1. Convert images to latent space (both image and control image are encoded)
                ...
                #* 10.2. Sample and add noise to the latents
                ...
                #* 10.4. latent image ids for RoPE.
                ...
                #* 10.8. Compute the loss and do backward pass
            ...
            #* 10.9. Checks if the accelerator has performed an optimization step behind the scenes
            if accelerator.sync_gradients:
