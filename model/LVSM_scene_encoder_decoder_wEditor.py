    ...
    def _run_multi_edit_chain(self, latent_tokens, input_dict, token_dim):
        ...
        for step_idx in range(max_steps):
            ...
            if step_idx != -1:
                ...
                edited_latent_tokens_bf16 = edited_latent_tokens.to(torch.bfloat16)
                edited_latent_tokens_fp32 = edited_latent_tokens_bf16.to(torch.float32)
                updated_latent_tokens = torch.where(active_mask, edited_latent_tokens_fp32, updated_latent_tokens)
