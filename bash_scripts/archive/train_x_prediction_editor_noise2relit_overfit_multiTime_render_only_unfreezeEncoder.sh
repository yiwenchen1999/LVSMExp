...
#SBATCH --job-name=relight_x_prediction_overfit_multiTime_render_only_trainEncoder
#SBATCH --mem=128
#SBATCH --ntasks=32
#SBATCH --output=myjob.relight_x_prediction_overfit_multiTime_render_only_trainEncoder.out
#SBATCH --error=myjob.relight_x_prediction_overfit_multiTime_render_only_trainEncoder.err
...
torchrun --nproc_per_node 1 --nnodes 1 \
    ...
    training.checkpoint_dir = ckpt/LVSM_x_prediction_editor_noise2relit_overfit_multiTime_render_only_trainEncoder \
    training.LVSM_checkpoint_dir = ckpt/LVSM_scene_encoder_decoder \
    training.wandb_exp_name = LVSM_x_prediction_overfit_multiTime_render_only_trainEncoder \
