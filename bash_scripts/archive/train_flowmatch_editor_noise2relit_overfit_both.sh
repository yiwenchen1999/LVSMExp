...
#SBATCH --mem=128
#SBATCH --ntasks=32
#SBATCH --output=myjob.relight_flowmatch_overfit_both.out
#SBATCH --error=myjob.relight_flowmatch_overfit_both.err
...
torchrun --nproc_per_node 1 --nnodes 1 \
    --rdzv_id 18637 --rdzv_backend c10d --rdzv_endpoint localhost:29509 \
    ...
    training.checkpoint_dir = ckpt/LVSM_flow_match_editor_noise2relit_overfit_both \
    training.LVSM_checkpoint_dir = ckpt/LVSM_scene_encoder_decoder \
    training.wandb_exp_name = LVSM_flowmatch_overfit_both \
