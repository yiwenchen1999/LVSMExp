#!/usr/bin/env bash
# Recon-only variant: run scene-dense DPT + backbone finetuning (encoder -> decoder
# only, no editor pass) on an ALLOCATED Sony GPU node.
...
############################
echo "=============================================="
echo "Train on allocated GPU: scene dense DPT head (RECON-ONLY)"
echo "=============================================="
echo "Host: $(hostname)"
echo "PROJ: $PROJ"
...
echo ""
echo "=============================================="
echo "Done (recon-only). Checkpoints: $CHECKPOINT_DIR"
echo "=============================================="
