...
#SBATCH --job-name=relight_flowmatch_overfit_chamfer_render_only
#SBATCH --mem=128
#SBATCH --ntasks=32
#SBATCH --output=myjob.relight_flowmatch_overfit_chamfer_render_only.out
#SBATCH --error=myjob.relight_flowmatch_overfit_chamfer_render_only.err
...
torchrun --nproc_per_node 1 --nnodes 1 \
    --rdzv_id 18637 --rdzv_backend c10d --rdzv_endpoint localhost:29505 \
