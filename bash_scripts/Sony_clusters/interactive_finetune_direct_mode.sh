#!/bin/bash
# Interactive finetune with DIRECT mode on lvsmPlus_objaverse (Sony cluster).
# Direct mode: editor directly predicts latent_tokens_final
# Usage: source bash_scripts/Sony_clusters/interactive_finetune_direct_mode.sh
#   or:  bash bash_scripts/Sony_clusters/interactive_finetune_direct_mode.sh
