#!/bin/bash
# Interactive inference for polyhaven dataset on Sony cluster (same_pose mode)
...
export OUTPUT_DIR="/music-shared-disk/group/ct/yiwen/codes/LVSMExp/experiments/evaluation/polyhaven_dense_inference_same_pose"

############################
# Logging
############################
echo "=============================================="
echo "Inference for Polyhaven Dataset - SAME POSE (Sony)"
echo "=============================================="
echo "Host: $(hostname)"
echo "PROJ: $PROJ"
...
# Confirmation
############################
read -p "Proceed with same_pose inference? [y/N]: " CONFIRM
if [[ ! "$CONFIRM" =~ ^[Yy]$ ]]; then
  echo "Cancelled."
  exit 0
fi
...
############################
echo ""
echo "Starting same_pose inference..."
...
echo ""
echo "=============================================="
echo "✓ Same-pose inference complete!"
echo "=============================================="
