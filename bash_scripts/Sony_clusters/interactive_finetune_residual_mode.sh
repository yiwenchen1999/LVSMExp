#!/bin/bash
# Interactive finetune with RESIDUAL mode on lvsmPlus_objaverse (Sony cluster).
# Residual mode: editor predicts residual and adds to latent_tokens
# Usage: source bash_scripts/Sony_clusters/interactive_finetune_residual_mode.sh
#   or:  bash bash_scripts/Sony_clusters/interactive_finetune_residual_mode.sh
