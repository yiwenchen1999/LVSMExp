...
#SBATCH --output=/group2/ct/yiwen/logs/infer_stanford_512_sony.out
#SBATCH --error=/group2/ct/yiwen/logs/infer_stanford_512_sony.err
...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-$PROJ/ckpt/infer_stanford_512_sony}"
export RESUME_CKPT="${RESUME_CKPT:-$PROJ/ckpt/recon_stanford_512_sony}"
export WANDB_EXP_NAME="${WANDB_EXP_NAME:-infer_stanford_512_sony}"
