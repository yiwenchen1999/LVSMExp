...
rsync -avh --partial --inplace --progress \
  ...
  chen.yiwe@xfer.discovery.neu.edu:/projects/vig/yiwenc/ResearchProjects/lightingDiffusion/3dgs/LVSMExp/ckpt/dense_relight_env_progressive/ckpt_0000000000006000.pt  \
  ckpt/progressive_results_finetuned/
