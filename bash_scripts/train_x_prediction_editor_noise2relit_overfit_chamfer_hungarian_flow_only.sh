...
#SBATCH --job-name=relight_x_prediction_overfit_chamfer_hungarian_flow_only
#SBATCH --mem=128
#SBATCH --ntasks=32
#SBATCH --output=myjob.relight_x_prediction_overfit_chamfer_hungarian_flow_only.out
#SBATCH --error=myjob.relight_x_prediction_overfit_chamfer_hungarian_flow_only.err
...
torchrun --nproc_per_node 1 --nnodes 1 \
    --rdzv_id 18644 --rdzv_backend c10d --rdzv_endpoint localhost:29506 \
    ...
    training.checkpoint_dir = ckpt/LVSM_x_prediction_editor_noise2relit_overfit_chamfer_hungarian_flow_only \
    training.LVSM_checkpoint_dir = ckpt/LVSM_scene_encoder_decoder \
    training.wandb_exp_name = LVSM_x_prediction_overfit_chamfer_hungarian_flow_only \
