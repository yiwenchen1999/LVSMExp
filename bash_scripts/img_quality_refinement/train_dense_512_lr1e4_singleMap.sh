...
#SBATCH --mem=128
#SBATCH --ntasks=32
#SBATCH --output=myjob.relight_dense_512_singleMap.out
#SBATCH --error=myjob.relight_dense_512_singleMap.err

# Relight editor training at 512x512 with single env-map sampling (see
# configs/LVSM_scene_encoder_decoder_wEditor_general_dense_512_singleMap.yaml).
# Pattern: bash_scripts/relight_general_dense_lr1e4_singleMap.sh + 512 resolution.
