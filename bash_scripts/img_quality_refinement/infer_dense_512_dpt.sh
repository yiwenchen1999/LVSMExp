...
torchrun --nproc_per_node 1 --nnodes 1 \
    ...
    training.checkpoint_dir = ckpt/infer_512_dpt \
    training.resume_ckpt = ckpt/LVSM_scene_encoder_decoder_wEditor_general_dense_512_singleMap_dpt_transfer/ckpt_0000000000012000.pt \
    ...
    training.dpt_transfer.stage1_steps = 0 \
