#!/usr/bin/env bash
# Pull mfml1 .../ckpt/infer_512_dpt_objaverse/iter_* and reorganize previews.
#
# Usage:
#   bash bash_scripts/img_quality_refinement/pull_infer_512_dpt_objaverse_from_sony.sh
#   REMOTE_HOST=mfml1 REMOTE_CKPT_DIR=... INFER_NAME=... DEST_DIR=... bash ...
#   PULL_ONLY=1 bash ...
...
export REMOTE_CKPT_DIR="${REMOTE_CKPT_DIR:-/music-shared-disk/group/ct/yiwen/codes/LVSMExp/ckpt/infer_512_dpt_objaverse}"

INFER_NAME="${INFER_NAME:-infer_512_dpt_objaverse}"
