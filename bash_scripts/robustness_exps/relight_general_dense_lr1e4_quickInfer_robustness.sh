...
torchrun --nproc_per_node 1 --nnodes 1 \
    ...
    train.py --config configs/LVSM_scene_encoder_decoder_general_dense.yaml \
    ...
    training.checkpoint_dir = ckpt/camera_robustness_test \
    training.wandb_exp_name = camera_robustness_test \
