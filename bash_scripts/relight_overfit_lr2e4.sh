...
#SBATCH --job-name=overfit_objaverse_lr2e4
#SBATCH --mem=32
#SBATCH --ntasks=4
#SBATCH --output=myjob.overfit_objaverse_lr2e4.out
#SBATCH --error=myjob.overfit_objaverse_lr2e4.err
...
torchrun --nproc_per_node 1 --nnodes 1 \
    ...
    training.checkpoint_dir = ckpt/LVSM_scene_encoder_decoder_wEditor_overfit_lr2e4 \
    training.LVSM_checkpoint_dir = ckpt/LVSM_object_encoder_decoder \
    training.wandb_exp_name = LVSM_edit_lr2e4_sparse_overfit \
    training.lr = 0.0002
