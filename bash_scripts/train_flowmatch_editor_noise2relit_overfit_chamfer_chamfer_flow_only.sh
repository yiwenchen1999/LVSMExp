...
#SBATCH --job-name=relight_flowmatch_overfit_chamfer_chamfer_flow_only
#SBATCH --mem=128
#SBATCH --ntasks=32
#SBATCH --output=myjob.relight_flowmatch_overfit_chamfer_chamfer_flow_only.out
#SBATCH --error=myjob.relight_flowmatch_overfit_chamfer_chamfer_flow_only.err
